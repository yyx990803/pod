...
api.createApp = function (appname, options, callback) {
    ...
    if (globalConfig.apps[appname]) {
        abort(ERRORS.EXISTS, callback, { appname: appname })
        return
    }
...
api.removeApp = function (appname, callback) {
    ...
    if (!app) {
        abort(ERRORS.NOT_FOUND, callback, { appname: appname })
        return
    }
...
api.startApp = function (appname, callback) {
    ...
    fs.exists(app.script, function (exists) {
        if (!exists) {
            abort(ERRORS.NO_SCRIPT, callback, { appname: appname, script: app.script })
            return
        }
...
function abort (msg, callback, data) {
